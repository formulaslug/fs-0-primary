...
#define FLEXCAN_set_rffn(ctrl2,                       \
      rffn) ctrl2 = ((ctrl2) & ~FLEXCAN_CTRL2_RFFN) | \
      ((rffn & 0xF) << FLEXCAN_CTRL2_RFFN_BIT_NO)
...
#define FLEXCAN_ESR_get_fault_code(esr) (((esr) & FLEXCAN_ESR_FLT_CONF_MASK) >> \
  4)
...
#define FLEXCAN_get_LTM(esr2_value) (((esr2_value) & (FLEXCAN_ESR2_LTM)) >> \
  (FLEXCAN_ESR2_LTM_BIT_NO))
...
#define FLEXCAN_Set_IMEUP(imeur,                             \
      imeup) imeur = (imeur & ~(FLEXCAN_IMEUR_IMEUP_MASK)) | \
...
#define FLEXCAN_Get_LostMBLocked(lrfr) ((lrfr & FLEXCAN_LRFR_LOSTRLP_MASK) >> \
  (FLEXCAN_LRFR_LOSTRLP_BIT_NO))
...
#define FLEXCAN_RERRSYNR_check_BEn_Bit(errsynr, \
      n) (errsynr & FLEXCAN_RERRSYNR_BE##n##_MASK)
#define FLEXCAN_RERRSYNR_get_SYNDn(errsynr, \
      n) (errsynr & FLEXCAN_RERRSYNR_SYND##n##_MASK)
#define FLEXCAN_RERRSYNR_check_SYNDn_Bit(errsynr,        \
      n) ((errsynr & FLEXCAN_RERRSYNR_SYND##n##_MASK) >> \
  FLEXCAN_RERRSYNR_SYND##n##_BIT_NO)
